  ...
  await upsertPage(payload, 'home', {
    ...
    layout: [
      ...
      },
      {
        ...
        items: [
          {
            title: 'Healthcare — First Zero Trust *Clinic*',
            summary: 'Designed and delivered the first enterprise Zero Trust healthcare clinic. Eliminated VPN dependency across clinical and administrative environments and deployed AI guardrail controls for clinical GenAI workflows.',
            lede: 'Designing and delivering the first enterprise Zero Trust healthcare clinic — VPN-free across clinical and administrative environments.',
            stats: [
              { value: 'First', label: 'enterprise ZT clinic' },
              { value: 'VPN-free', label: 'clinical & admin access' },
              { value: 'GenAI', label: 'guardrails for clinical AI' },
            ],
            situation: 'A large healthcare system needed a clinic environment that met modern Zero Trust expectations: no flat clinical network, no VPN dependency for staff, and controls capable of governing an emerging set of clinical GenAI workflows.',
            approach: [
              { text: 'Identity-centric access design for clinical and administrative users' },
              { text: 'ZPA replacing VPN for internal application access' },
              { text: 'Segmentation isolating clinical systems and connected medical devices' },
              { text: 'Inline AI guardrail controls for clinical GenAI tooling' },
            ],
            outcome: 'The first enterprise Zero Trust clinic delivered — VPN dependency eliminated for clinical and administrative staff, and a repeatable architecture pattern established for the rest of the estate.',
          },
          {
            title: 'Enterprise M&A — Merger *Stabilization*',
            summary: 'Primary security authority during a 120,000+ user enterprise merger experiencing production-blocking failures. Established a unified Zero Trust posture across both entities and recovered tenant stability.',
            lede: 'Primary security authority for a 120,000+ user merger with production-blocking failures across both estates.',
            stats: [
              { value: '120K+', label: 'users across both entities' },
              { value: '2', label: 'Zscaler estates unified' },
              { value: 'Primary', label: 'security authority' },
            ],
            situation: 'Two large enterprises combining — with overlapping Zscaler tenants, conflicting policy frameworks, and failures severe enough to block production work for end users.',
            approach: [
              { text: 'Acted as primary security authority across both entities' },
              { text: 'Unified the Zero Trust posture and identity model' },
              { text: 'Reconciled two conflicting policy frameworks into one' },
              { text: 'Stabilized App Connector and tenant configuration' },
              { text: 'Staged migration in controlled waves with rollback drills' },
            ],
            outcome: 'A single, stable Zero Trust posture across the combined 120,000+ user organization — production failures resolved and a repeatable post-merger playbook left behind.',
          },
          {
            title: 'Financial Services — ZT Program *Recovery*',
            summary: 'Recovered a Zero Trust initiative stalled in proof-of-concept for over two years. Re-architected the program for operational execution during a major brokerage merger — delivering results where previous efforts had failed.',
            lede: 'Recovering a Zero Trust program stalled in proof-of-concept for over two years — and delivering it during a major merger.',
            stats: [
              { value: '2+ yrs', label: 'stalled in proof-of-concept' },
              { value: 'Live', label: 'moved to operational execution' },
              { value: 'M&A', label: 'delivered through the merger' },
            ],
            situation: 'A Zero Trust initiative had been stuck in proof-of-concept for more than two years with no path to production — while a major brokerage merger raised both the stakes and the complexity.',
            approach: [
              { text: 'Re-scoped the program around operational execution, not indefinite evaluation' },
              { text: 'Rebuilt the architecture for a production rollout' },
              { text: 'Sequenced delivery to absorb merger complexity' },
              { text: 'Established measurable milestones where prior efforts had none' },
            ],
            outcome: 'A Zero Trust program moved out of two-year proof-of-concept and into operational execution — delivering results during the merger where previous efforts had repeatedly failed.',
          },
        ],
      },
      {
